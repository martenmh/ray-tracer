...
public:
    ...
    /* Inline methods (small & used often)
       Access methods:
    */
    ...
    static vec3 make_unit_vector(vec3 v);
...
inline float dot(const vec3 &v1, const vec3 &v2){ return (v1.e[0] * v2.e[0]) + (v1.e[1] * v1.e[1]) + (v1.e[2] * v2.e[2]); }

inline vec3 cross(const vec3 &v1, const vec3 &v2){ return vec3(
